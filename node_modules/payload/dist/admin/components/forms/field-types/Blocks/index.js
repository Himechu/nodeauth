    ...
    return (react_1.default.createElement("div", { id: `field-${path.replace(/\./gi, '__')}`, className: classes },
        ...
        react_1.default.createElement(DraggableSortable_1.default, { ids: rows.map((row) => row.id), onDragEnd: ({ moveFromIndex, moveToIndex }) => moveRow(moveFromIndex, moveToIndex) },
            rows.length > 0 && rows.map((row, i) => {
                ...
                const rowNumber = i + 1;
                if (blockToRender) {
                    return (react_1.default.createElement(DraggableSortableItem_1.default, { key: row.id, id: row.id, disabled: readOnly }, ({ setNodeRef, transform, attributes, listeners }) => {
                        var _a, _b;
                        return (react_1.default.createElement("div", { id: `${path}-row-${i}`, ref: setNodeRef, style: {
                                transform,
                            } },
                            react_1.default.createElement(Collapsible_1.Collapsible, { collapsed: row.collapsed, onToggle: (collapsed) => setCollapse(row.id, collapsed), className: `${baseClass}__row`, key: row.id, dragHandleProps: {
                                ...
                                react_1.default.createElement(RenderFields_1.default, { className: `${baseClass}__fields`, readOnly: readOnly, fieldTypes: fieldTypes, permissions: (_b = (_a = permissions === null || permissions === void 0 ? void 0 : permissions.blocks) === null || _a === void 0 ? void 0 : _a[blockType]) === null || _b === void 0 ? void 0 : _b.fields, fieldSchema: blockToRender.fields.map((field) => ({
                                        ...field,
